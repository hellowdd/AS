		...
		<form class="form-horizontal evaform" role="form" id="infoForm">
			...
			<div class="form-group">
                ...
                <div class="col-xs-9 add_fin">
                   <textarea class="form-control" id="appJudge" name='appJudge' len="50"></textarea>         
                </div> 
			</div>
...
$(document).ready(function() {
    ...
    $("#submit").click(function() {
        var rej = {
				...
				appScore:selEva,
				appJudge:$("#appJudge").val(),//评价
				isPublic:$("#isPublic").val()		    
            }
         if($("#appJudge").val() == ""){
        	window.parent.layer.alert("请填写评语！");
        		return false;
        }else if($("#appJudge").val().length >=1000){
        ...
        $.ajax({
            ...
            url: "${pageContext.request.contextPath}/manager/rest/appJudge/insertAppJudge",
